...
* **Parameters:**
  ...
  * **brace_direction** ([*Vector3DLike*](manim.typing.md#manim.typing.Vector3DLike)) – The direction of the brace. By default `DOWN`.
  ...
  * **brace_config** (*dict* *[**str* *,* *Any* *]*  *|* *None*) – Arguments to be passed to [`Brace`](manim.mobject.svg.brace.Brace.md#manim.mobject.svg.brace.Brace).
...
* **Parameters:**
  ...
  * **text** (*str*)
  * **brace_direction** ([*Vector3DLike*](manim.typing.md#manim.typing.Vector3DLike))
